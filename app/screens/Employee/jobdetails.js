    ...
    <View style={styles.screen}>
      ...
      <View styles={styles.cont}>
        ...
        <Text>
          ...
          tribal communities of Rohtak district (Haryana). We always stressed on
          activities and strategies that cover the whole cycle of what is
          required for providing quality education to an individual child in a
          structured manner. Our mission is to build a platform for vulnerable
          and oppressed children, living in poverty. Thus empowering them with a
